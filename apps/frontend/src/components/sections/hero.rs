...
pub fn HeroSection(props: &HeroSectionProps) -> Html {
    ...
    html! {
        <section class="relative py-16 md:py-24" data-doc="Hero section: headline + code card.">
            ...
            <div class="mx-auto grid max-w-[1280px] gap-10 px-4 md:px-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-16">
                <div>
                ...
                <div class="neon-border w-full rounded-xl border border-[#392c28] bg-[#0d0d0d] shadow-[0_24px_60px_rgba(0,0,0,0.5)]">
                    ...
                    <pre class="custom-scrollbar overflow-x-auto px-6 py-5 font-mono text-sm leading-relaxed sm:text-base">
